 ...
 * @author salam
 */
public class FPaymentSelection extends javax.swing.JFrame {

    private GeneralDB gdb;

    /** Creates new form FPaymentSelection */
    public FPaymentSelection() {
        initComponents();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(tfTitle, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 607, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void tblInvoiceMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblInvoiceMouseClicked
        ...
        if (clickCount == 2) {
            ...
            if (status.compareToIgnoreCase("PAID") == 0) {
                Utils.msg("This invoice is already paid");
            } else {
                FPayment fp = new FPayment(invoiceID, studentID);
                fp.setVisible(true);
            }
